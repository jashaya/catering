...
<form id="form1" name="form1" method="post" action="includes/codvenue.php">
  <table width="325" border="0">
    ...
    <tr>
      <td width="105"><font color="#996633">Delivery date</font></td>
    ...
    <tr>
      ...
      <input type="text" name="txtphone" id="text1" />
...
var sprytextfield3 = new Spry.Widget.ValidationTextField("txtphone", "integer", {useCharacterMasking:true, minChars:10, maxChars:15, validateOn:["change"]});
</script>
</body>
</html>